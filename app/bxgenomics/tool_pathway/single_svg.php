...
// echo "<pre>" . print_r($svg_data, true) . "</pre>";
				...
				if (allGeneInfo.hasOwnProperty(annotation_text_new)) {
					...
					for(var key in geneInfo) {
						...
						if(content == ''){
							...
							if(info['GeneIndex'] != '') content += '<strong>Details: </strong><a target="_blank" href="../tool_search/view.php?type=gene&id=' + info['GeneIndex'] + '">View</a><BR />';
							content += '</div>';
						}
