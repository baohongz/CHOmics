      ...
      <div class="container-fluid">
        ...
        <form id="form_upload_files">
          <div class="row mt-3" id="container_form_upload_file_step_1">
            ...
            <div class="col-md-10">
              <input type="file" name="file1" id="input_upload_file_step_1" onchange="$('#btn_submit_upload_files').show()">
                <a href="files/PCA_input.data.csv"><i class="fas fa-caret-right"></i> Example Data File</a>
            </div>
          </div>
          ...
          <div class="row mt-3" id="container_form_upload_file_step_2">
            ...
            <div class="col-md-10">
              <input type="file" name="file2" id="input_upload_file_step_2">
              <a href="files/PCA_attributes.csv"><i class="fas fa-caret-right"></i> Example Attributes File</a>
            </div>
          </div>
          ...
          <div class="row mt-3" id="container_form_upload_file_step_3">
            ...
            <div class="col-md-10">
              <input type="file" name="file3" id="input_upload_file_step_3">
                <a href="files/PCA_variance.csv"><i class="fas fa-caret-right"></i> Example Variance File</a>
            </div>
          </div>
        ...
        <div class="row mt-1 mb-3" style="display:none;" id="container_detail_step_1">
          ...
          <div class="col-md-4">
            <select class="custom-select select_headers" id="select_x">
            </select>
          </div>
          <div class="col-md-2 text-right pt-2"><strong>Y: </strong></div>
          <div class="col-md-4">
            <select class="custom-select select_headers" id="select_y">
            </select>
          </div>
        </div>
        ...
        <div class="row mt-1 mb-3" style="display:none;" id="container_detail_step_2">
          ...
          <div class="col-md-4">
            <select class="custom-select select_legends" id="select_legend_1">
              <option value="">(None)</option>
            </select>
          </div>
          <div class="col-md-2 text-right pt-2"><strong>Shape By: </strong></div>
          <div class="col-md-4">
            <select class="custom-select select_legends" id="select_legend_2">
              <option value="">(None)</option>
            </select>
          </div>
        </div>
