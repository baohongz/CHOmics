...
<head>
	...
	$(document).ready(function(){
		...
		$(document).on('click', '#btn_submit', function(){
			var options = {
				url: 'exe.php?action=draw_pic&id=' + Date.now(),
				type: 'post',
	  			...
	  			<div class="container-fluid">
					...
					<div class="my-3">
						...
						<div class="my-3">
							...
							<a href="overlap.php" class="mx-2 btn btn-sm btn-success"><i class="fas fa-link"></i> Calculate overlap between lists and draw Venn Diagram</a>
						</div>
					</div>
					...
					<form id='form_example' role="form">
						...
						<div style="background-color:#EFF3F8;padding:20px;border:1px solid #438EB9;" id="data_div">

								<strong>Datasets Labels:</strong><br>
								<div class="number_box"><input type="text" class="form-control" placeholder="Label of Set A" name="labelA" id="labelA" value="A"></div>
								<div class="number_box"><input type="text" class="form-control" placeholder="Label of Set B" name="labelB" id="labelB" value="B"></div>
								<div class="number_box not_for_two"><input type="text" class="form-control" placeholder="Label of Set C" name="labelC" id="labelC" value="C"></div><br>

								<strong>Dataset Size (number only):</strong><br>
								<div class="number_box"><input type="text" class="form-control" placeholder="Size of A" name="A" id="A"></div>
								<div class="number_box"><input type="text" class="form-control" placeholder="Size of B" name="B" id="B"></div>
								<div class="number_box not_for_two"><input type="text" class="form-control" placeholder="Size of C" name="C" id="C"></div><br>

								<strong>Intersection Size (number only):</strong><br>
								<div class="number_box"><input type="text" class="form-control" placeholder="Size of A and B" name="AB" id="AB"></div>
								<div class="number_box not_for_two"><input type="text" class="form-control" placeholder="Size of A and C" name="AC" id="AC"></div>
								<div class="number_box not_for_two"><input type="text" class="form-control" placeholder="Size of B and C" name="BC" id="BC"></div>
								<div class="number_box not_for_two"><input type="text" class="form-control" placeholder="Size of A and B and C" name="ABC" id="ABC"></div><br>
