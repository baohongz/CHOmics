    ...
    (function(H) {
        ...
        Chart.prototype = {
            ...
            getChartSize: function() {
                ...
                chart.chartWidth = Math.max(0, widthOption || chart.containerWidth || 2400);
                // the offsetHeight of an empty container is 0 in standard browsers, but 19 in IE7:
                chart.chartHeight = Math.max(0, pick(heightOption, chart.containerHeight > 19 ? chart.containerHeight : 2400) );
            },
