...
$BXAF_CONFIG['BXAF_BXFILES_SHARED'] = false;
$BXAF_CONFIG['BXAF_BXFILES_SUBDIR'] = $BXAF_CONFIG['BXAF_BXFILES_SUBDIR_PRIVATE'];





$BXAF_BXFILES_PREFIX = $BXAF_CONFIG['BXAF_SYSTEM_URL'] . 'bxfiles/f.php?f=';
if(is_array($BXAF_CONFIG) && array_key_exists('BXAF_BXFILES_PRIVATE_PREFIX', $BXAF_CONFIG) && $BXAF_CONFIG['BXAF_BXFILES_PRIVATE_PREFIX'] != ''){
	$BXAF_BXFILES_PREFIX = $BXAF_CONFIG['BXAF_BXFILES_PRIVATE_PREFIX'];
}


$BXFILES_READONLY = false;
if(array_key_exists('BXFILES_PRIVATE_READONLY', $BXAF_CONFIG) && $BXAF_CONFIG['BXFILES_PRIVATE_READONLY']){
	$BXFILES_READONLY = true;
}

$BXAF_CONFIG['BXAF_PAGE_TITLE'] = "My Private Files";
