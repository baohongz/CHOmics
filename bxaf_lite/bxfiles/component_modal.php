...
<div class="modal fade" id="modal_confirm_create_folder">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-primary" data-dismiss="modal"><i class="fas fa-window-close"></i> Cancel</button>
				<button type="button" class="btn btn-sm btn-success" id="confirm_create_folder_btn"><i class="fas fa-folder-open"></i> Create</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modal_confirm_create_file">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-primary" data-dismiss="modal"><i class="fas fa-window-close"></i> Cancel</button>
				<button type="button" class="btn btn-sm btn-success" id="confirm_create_file_btn"><i class="fas fa-file-alt"></i> Create</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modal_edit_txt_file">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-primary" data-dismiss="modal"><i class="fas fa-window-close"></i> Cancel</button>
				<button type="button" class="btn btn-sm btn-success" id="confirm_edit_txt_file_btn"><i class="fas fa-file-alt"></i> Save</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modal_confirm_move_file">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-primary" data-dismiss="modal"><i class="fas fa-ban"></i> Cancel</button>
