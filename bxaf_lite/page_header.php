...
if ($BXAF_CONFIG['BXAF_PAGE_HEADER_LIBRARIES']['jquery']){
	echo "<script src='/{$BXAF_SYSTEM_SUBDIR}library/jquery/jquery.min.js.php'></script>\n";
}
...
if ($BXAF_CONFIG['BXAF_PAGE_HEADER_LIBRARIES']['popper']){
	echo "<script src='/{$BXAF_SYSTEM_SUBDIR}library/jquery/popper.min.js'></script>\n";
}
...
if ($BXAF_CONFIG['BXAF_PAGE_HEADER_LIBRARIES']['font-awesome']){
	// echo "<script src='/{$BXAF_SYSTEM_SUBDIR}library/fontawesome/js/all.min.js.php'></script>\n";
	echo "<link   href='/{$BXAF_SYSTEM_SUBDIR}library/fontawesome/css/all.min.css' rel='stylesheet' type='text/css'>\n";
}
