...
$BXAF_CONFIG['BXAF_PAGE_HEADER'] 		= dirname(__FILE__) . "/page_header.php";
$BXAF_CONFIG['BXAF_PAGE_MENU']			= dirname(__FILE__) . "/page_menu.php";
$BXAF_CONFIG['BXAF_PAGE_LEFT']			= dirname(__FILE__) . "/page_left.php";
$BXAF_CONFIG['BXAF_PAGE_FOOTER']		= dirname(__FILE__) . "/page_footer.php";
...
$BXAF_CONFIG['BXAF_LOGIN_REQUIRED']	= true;
...
//Check Login Status
if(isset($BXAF_CONFIG['BXAF_LOGIN_REQUIRED']) && $BXAF_CONFIG['BXAF_LOGIN_REQUIRED'] && (! isset($BXAF_CONFIG['PAGE_LOGIN_REQUIRED']) || $BXAF_CONFIG['PAGE_LOGIN_REQUIRED'] == true)) include_once(dirname(__FILE__) . "/login_config.php");
