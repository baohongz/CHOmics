...
if ($_GET['action'] == 'logout'){
	...
	// unset($_SESSION[$BXAF_CONFIG['BXAF_LOGIN_KEY']]);
				...
				<h2>Sign in your account</h2>
					...
					<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post' role='form'>
						...
						<div id="section_password" class="w-100<?php if(isset($BXAF_CONFIG['BXAF_USER_DEFAULT_PASSWORD']) && $BXAF_CONFIG['BXAF_USER_DEFAULT_PASSWORD'] != '') echo ' hidden'; ?>">
							...
							<input class="form-control mb-2" name="Password" id="Password" type="password" value="" placeholder="Password, case sensitive">
